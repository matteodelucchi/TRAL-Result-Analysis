...
subtitle: "Characterization and Functional Analysis of Tandem Repeats"
...
However, we can see, that Alanine is most frequent (14%) followed by Proline (12%) and Serine (12%) in CRC and Wnt-/$\beta$-catenin pathway associated proteins.
...
# Conclusion
With the aim to provide a functional analysis of TRs in CRC associated proteins and Wnt-pathway components, we could find TR-regions beeing potentially involved in CRC development.
